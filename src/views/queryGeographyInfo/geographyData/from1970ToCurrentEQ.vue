		...
		<div class="boxCenter">
			<div class="search">
				<el-form ref="form" :model="form" label-width="100px" :inline="false">
					<h3>条件查询</h3>
					<el-col :span="12">
						<el-form-item label="地点："><el-input v-model="form.placeName" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
					<el-col :span="12">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
					...
					<el-table-column width="180" align="center" prop="epiCenter" label="宏观震中烈度"></el-table-column>
				</el-table>
				<el-pagination
	...
	methods: {
		commonPart() {
			...
			let params = {
				...
				minMagnitude: this.form.minMangitude,
				maxMagnitude: this.form.maxMangitude,
				pageNo: this.pageNo,
				pageSize: this.pageSize
			};
			request({ url: '/getFrom1970ToCurrentEQlistAndCount', method: 'post', data: params }).then(res => {
