		...
		<div class="boxCenter">
			<div class="search">
				<el-form ref="form" :model="form" label-width="100px" :inline="false">
					<h3>条件查询</h3>
					<el-col :span="12">
						<el-form-item label="机场名称："><el-input v-model="form.airportName" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
					...
					<el-table-column prop="location" label="所属省份、县" align="center"></el-table-column>
					<el-table-column prop="other" label="飞行区等级" align="center"></el-table-column>
					<el-table-column prop="isCivil" label="是否民用机场" align="center"></el-table-column>
					<el-table-column prop="plane" label="起降机型" align="center"></el-table-column>
					<el-table-column prop="note" label="简介" width="350px" align="center"></el-table-column>
				</el-table>
				<el-pagination
...
export default {
	...
	methods: {
		commonPart() {
			//获取历史强震的数据列表及总记录数
			let params = { airportName: this.form.airportName, pageNo: this.pageNo, pageSize: this.pageSize };
			request({ url: '/getAirportListAndCount', method: 'post', data: params }).then(res => {
