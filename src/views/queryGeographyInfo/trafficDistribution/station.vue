		...
		<div class="boxCenter">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 65px)" style="width: 100%">
					...
					<el-table-column prop="name" label="台点名称" align="center"></el-table-column>
				</el-table>
				<el-pagination
...
export default {
	...
	methods: {
		commonPart() {
			//获取桥梁相关数据
			let params = { name: this.form.name, pageNo: this.pageNo, pageSize: this.pageSize };
			request({ url: '/getStationClassListAndGradeListAndCountAndList', method: 'post', data: params }).then(res => {
