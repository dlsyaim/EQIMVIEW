		...
		<div class="boxCenter">
			<div class="search">
				<el-form ref="form" :model="form" label-width="120px" :inline="false">
					<h3>条件查询</h3>
					<el-col :span="12">
						<el-form-item label="名称："><el-input v-model="form.metroStationName" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
			...
			<div class="tableBox">
				<h3>查询结果</h3>
					<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
						...
						<el-table-column prop="metroStationname" label="站点名称"   align="center"></el-table-column>
						<el-table-column prop="simplename" label="简称"   align="center"></el-table-column>
						<el-table-column prop="changename" label="换乘线路"   align="center"></el-table-column>
						<el-table-column prop="linebelong" label="所属线路"   align="center"></el-table-column>
						<el-table-column prop="sxstarttime" label="上行首班车时间"   align="center"></el-table-column>
						<el-table-column prop="sxendtime" label="上行末班车时间"   align="center"></el-table-column>
						<el-table-column prop="xxstarttime" label="下行首班车时间"   align="center"></el-table-column>
						<el-table-column prop="xxendtime" label="下行末班车时间"   align="center"></el-table-column>
					</el-table>
					<el-pagination
...
export default {
	...
	methods: {
		commonPart() {
			//获取地铁线路的数据列表及总记录数
			let params = { metroStationName: this.form.metroStationName, pageNo: this.pageNo, pageSize: this.pageSize };
			request({ url: '/getMetroStationCountAndList', method: 'post', data: params }).then(res => {
				let data = res.data.result;
				console.log(data);
				this.tableData = data.list;
				this.count = data.count;
				// this.form.metroStationClassList=data.selectList;
				this.isLoad = false;
			});
		},
		//重置数据
		resetData() {
			this.form.metroStationName = null;
			// this.form.metroStationClass=null;
		},
		//查询
		doSearch() {
			this.pageNo = 1;
