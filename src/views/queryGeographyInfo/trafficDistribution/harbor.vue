		...
		<div class="boxCenter">
			<div class="search">
				<el-form ref="form" :model="form" label-width="120px" :inline="false">
					<h3>条件查询</h3>
					<el-col :span="12">
						<el-form-item label="港口名称："><el-input v-model="form.harborName" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="年吞吐量：">
							<el-input v-model="form.minHarborVolume" size="mini" style="width: 40%;"></el-input>
							~
							<el-input v-model="form.maxHarborVolume" size="mini" style="width: 40%;"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="抗震设防烈度："><el-input v-model="form.harborIntensity" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
					...
					<el-table-column prop="harborName" label="港口名称"   align="center"></el-table-column>
					...
					<el-table-column prop="harborVolume" label="年吞吐量"   align="center"></el-table-column>
					<el-table-column prop="harborIntensity" label="抗震设防烈度"   align="center"></el-table-column>
					<el-table-column prop="harborNote" label="隧道简介" width="350" align="center"></el-table-column>
				</el-table>
				<el-pagination
...
export default {
	...
	methods: {
		commonPart() {
			//获取港口相关数据
			let params = {
				harborName: this.form.harborName,
				minHarborVolume: this.form.minHarborVolume,
				maxHarborVolume: this.form.maxHarborVolume,
				harborIntensity: this.form.harborIntensity,
				pageNo: this.pageNo,
				pageSize: this.pageSize
			};
			request({ url: '/getHarborCountAndList', method: 'post', data: params }).then(res => {
		...
		//重置数据
		resetData() {
			this.form.harborName = null;
			this.form.minHarborVolume = null;
			this.form.maxHarborVolume = null;
			this.form.harborIntensity = null;
		},
		//查询
		doSearch() {
			this.pageNo = 1;
