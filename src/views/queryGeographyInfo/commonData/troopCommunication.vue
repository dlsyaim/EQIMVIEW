		...
		<div class="boxCenter">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
					...
					<el-table-column prop="name" label="队伍名称" align="center"></el-table-column>
					<el-table-column prop="postcode" label="邮政编码" align="center"></el-table-column>
					<el-table-column prop="scale" label="队伍规模" align="center"></el-table-column>
					<el-table-column prop="location" label="驻地市县" align="center"></el-table-column>
...
export default {
	...
	methods: {
		...
		dataQuery() {
			...
			request({ url: '/commonData/troopCommunication/list', method: 'post', data: pageCondition })
				.then(res => {
			...
			request({
				url: '/commonData/troopCommunication/getCount',
				method: 'post',
				data: {
					name: this.queryCondition.name
				}
