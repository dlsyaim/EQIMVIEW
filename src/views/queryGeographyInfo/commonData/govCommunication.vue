		...
		<div class="boxCenter">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
					...
					<el-table-column prop="tel1" label="政府值班电话1" align="center"></el-table-column>
					<el-table-column prop="tel2" label="政府值班电话2" align="center"></el-table-column>
					<el-table-column prop="linkman" label="联系人姓名" align="center"></el-table-column>
...
export default {
	...
	methods: {
		...
		dataQuery() {
			...
			request({ url: '/commonData/govCommunication/list', method: 'post', data: pageCondition })
				.then(res => {
			...
			request({
				url: '/commonData/govCommunication/getCount',
				method: 'post',
				data: {
					name: this.queryCondition.name
				}
