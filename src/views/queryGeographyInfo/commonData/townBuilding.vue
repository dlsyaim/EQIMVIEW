		...
		<div class="boxCenter">
				...
				<el-form ref="form" :model="form" label-width="120px" :inline="false">
					...
					<el-col :span="12">
						<el-form-item label="乡镇名称：" prop="name">
							<el-input style="width:60%;" size="mini" placeholder="请输入乡镇名称" type="text" v-model="queryCondition.name"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="人均居住面积：" prop="average">
							<el-input style="width:40%;" placeholder="最小人均居住面积" type="text" size="mini" v-model="queryCondition.averageMin"></el-input>
							~
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" width="100%">
					...
					<el-table-column prop="name" label="乡镇名称" align="center"></el-table-column>
					...
					<el-table-column prop="rcframeProperty" label="多层钢筋混凝土房屋单位面积平均室内财产价值" width="280" align="center"></el-table-column>
...
export default {
	...
	methods: {
		...
		dataQuery() {
			...
			request({ url: '/commonData/townBuilding/list', method: 'post', data: pageCondition })
				.then(res => {
			...
			request({
				url: '/commonData/townBuilding/getCount',
				method: 'post',
				data: {
					name: this.queryCondition.name,
					totalAreaMin: this.queryCondition.totalAreaMin,
