		...
		<div class="boxCenter">
			<div class="search">
				<el-form ref="form" :model="form" label-width="120px" :inline="false">
					...
					<el-col :span="12">
						<el-form-item label="总人口：" prop="total">
							<el-input style="width:40%;" size="mini" placeholder="开始人口数量" type="text" v-model="queryCondition.totalMin"></el-input>
							~
							<el-input placeholder="结束人口数量" style="width:40%;" size="mini" type="text" v-model="queryCondition.totalMax"></el-input>
						</el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
...
export default {
	...
	methods: {
		...
		dataQuery() {
			...
			request({ url: '/commonData/townStatistics/list', method: 'post', data: pageCondition })
				.then(res => {
			...
			request({
				url: '/commonData/townStatistics/getCount',
				method: 'post',
				data: {
					name: this.queryCondition.name,
					totalMin: this.queryCondition.totalMin,
