		...
		<div class="boxCenter">
				...
				<el-form ref="form" :model="form" label-width="130px" :inline="false">
					...
					<el-col :span="12">
						<el-form-item label="消防队名称：" prop="name">
							<el-input style="width:60%;" size="mini" placeholder="请输入消防队名称" type="text" v-model="queryCondition.name"></el-input>
						</el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
					<el-button type="primary" size="mini" @click="dataQuery" style="margin-top:10px;" icon="el-icon-search" :loading="isLoad">查询</el-button>
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 65px)" width="100%">
					...
					<el-table-column prop="name" label="消防队名称" align="center"></el-table-column>
					...
					<el-table-column prop="staff" label="人数" align="center"></el-table-column>
					<el-table-column prop="fireTruck" label="消防车辆" align="center"></el-table-column>
					<el-table-column prop="note" label="消防能力描述" align="center"></el-table-column>
				</el-table>
				<el-pagination
...
export default {
	...
	methods: {
		...
		dataQuery() {
			...
			request({ url: '/commonData/firePower/list', method: 'post', data: pageCondition })
				.then(res => {
			...
			request({
				url: '/commonData/firePower/getCount',
				method: 'post',
				data: {
					name: this.queryCondition.name
				}
