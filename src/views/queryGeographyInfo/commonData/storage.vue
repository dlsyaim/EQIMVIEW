		...
		<div class="boxCenter">
				...
				<el-form ref="form" :model="form" label-width="130px" :inline="false">
					...
					<el-col :span="12">
						<el-form-item label="名称：" prop="name">
							<el-input style="width:60%;" size="mini" placeholder="请输入储备库名称" type="text" v-model="queryCondition.name"></el-input>
						</el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
			...
			<div class="tableBox">
				...
				<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 65px)" style="width: 100%">
					...
					<el-table-column prop="note" label="简介" width="150" align="center"></el-table-column>
				</el-table>
				<el-pagination
...
export default {
	...
	methods: {
		...
		dataQuery() {
			...
			request({ url: '/commonData/storage/list', method: 'post', data: pageCondition })
				.then(res => {
			...
			request({
				url: '/commonData/storage/getCount',
				method: 'post',
				data: {
					name: this.queryCondition.name
				}
