		...
		<div class="boxCenter">
			<div class="search">
				<el-form ref="form" :model="form" label-width="100px" :inline="false">
					<h3>条件查询</h3>
					<el-col :span="12">
						<el-form-item label="岩体名称："><el-input v-model="form.unitName" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="岩体描述："><el-input v-model="form.character" size="mini" style="width: 60%;"></el-input></el-form-item>
					</el-col>
				</el-form>
				<div class="btnCenter">
			...
			<div class="tableBox">
				<h3>查询结果</h3>
					<el-table :data="tableData" v-loading="isLoad" border height="calc(100% - 100px)" style="width: 100%">
						...
						<el-table-column prop="unitName" label="岩体名称"  align="center"></el-table-column>
						<el-table-column prop="symbol" label="岩体符号"    align="center"></el-table-column>
						<el-table-column prop="character" label="岩体描述" align="center"></el-table-column>
					</el-table>
				<el-pagination
...
export default {
	...
	methods: {
		commonPart() {
			...
			request({ url: '/getRocklistAndcount', method: 'post', data: params }).then(res => {
